...
LITERALS = [[None, '@router.get("/{sched_id}/result")'], [None, '"scheduled_result.html"'], [None, '{"request": request, "schedule": schedule, "results": results}'], [None, '"error": "schedule not found"']]
