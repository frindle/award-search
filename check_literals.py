...
LITERALS = [[None, '@router.post("/{sched_id}")'], [None, 'def scheduled_edit_save(sched_id: str, body: EditRequest):'], [None, 'class EditRequest(BaseModel):'], [None, '# PRESERVES created_at/last_checked/last_results/notified_keys from the existing record on an edit.']]
