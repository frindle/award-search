...
LITERALS = [[None, '@router.post("/{sched_id}/run")'], [None, 'async def scheduled_run_by_id(sched_id: str):'], [None, 'await anyio.to_thread.run_sync(run_schedule, schedule)'], [None, '"schedule not found"'], [None, 'import anyio']]
