...
TARGET = pathlib.Path('src/transfer_partners.py')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, 'TRANSFER_POINTS = {'], [None, 'def get_transfer_points(program):'], [None, '"Citi ThankYou Points"'], [None, '"flying_blue": "Citi ThankYou Points",'], [None, '"jetblue": "Citi ThankYou Points",'], [None, '"qantas": "Citi ThankYou Points",'], [None, '"qatar": "Citi ThankYou Points",'], [None, '"singapore": "Citi ThankYou Points",'], [None, '"turkish": "Citi ThankYou Points",'], [None, '"virgin_atlantic": "Citi ThankYou Points",'], [None, '"etihad": "Citi ThankYou Points",'], [None, '"emirates": "Citi ThankYou Points",']]
...
def _parse_must_contain(task_text):
    ...
    for line in m.group(1).splitlines():
        if not re.match(r"\s*-\s", line):
            continue  # only real `- ` list items; skip instructional prose/parentheticals
