...
LITERALS = [[None, '@router.get("/scheduled/{sched_id}/edit")'], [None, 'def scheduled_edit(request: Request, sched_id: str):'], [None, '"mode": "edit"'], [None, '"schedule not found"'], [None, 'set_schedules']]
