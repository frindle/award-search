...
LITERALS = [[None, "RedirectResponse('/scheduled?saved=1', status_code=303)"], [None, '@router.post("/scheduled/save")'], [None, 'async def scheduled_save(request: Request):'], [None, 'from starlette.responses import RedirectResponse']]
