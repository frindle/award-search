...
LITERALS = [[None, 'import logging'], [None, 'log = logging.getLogger(__name__)'], [None, 'log.exception("select_results: dropping result %r", r.get("availability_id"))'], [None, 'log.exception("run_cycle: search failed for alert %s", alert_id)']]
