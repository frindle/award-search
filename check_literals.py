...
LITERALS = [[None, '"American Express Membership Rewards"'], [None, '"hyatt_worldwide"'], [None, '"marriott_bonvoy"'], [None, '"hilton_honors"'], [None, '"delta_sky_miles"'], [None, '"Chase Ultimate Rewards"'], [None, '"southwest"'], [None, '"british_airways"']]
