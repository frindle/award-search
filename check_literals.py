...
LITERALS = [['src/webui/scheduled_routes.py', 'def parse_cap(value: Optional[str]) -> Optional[float|int]:'], ['src/webui/scheduled_routes.py', '"invalid cap value"'], ['src/webui/scheduled_routes.py', 'number.is_integer()']]
