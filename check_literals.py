...
LITERALS = [['src/transfer_partners.py', "'chase_ur'"], ['src/transfer_partners.py', "'Chase Ultimate Rewards'"], ['src/transfer_partners.py', "'air_canada'"], ['src/transfer_partners.py', "'american'"]]
