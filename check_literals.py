...
LITERALS = [[None, 'DEFAULT_POLL_MINUTES = 5'], [None, '(poll_minutes or DEFAULT_POLL_MINUTES) * 60'], [None, 'await asyncio.sleep((poll_minutes or DEFAULT_POLL_MINUTES) * 60)'], [None, 'async def schedule_scheduler(poll_minutes: Optional[float] = None) -> None:']]
