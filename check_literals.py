...
TARGET = pathlib.Path('src/alert_filters.py')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [['src/alert_filters.py', 'def passes_filters(result: Dict, filters: Optional[Dict]) -> bool'], ['src/alert_filters.py', 'def describe_filters(filters: Optional[Dict]) -> str'], ['src/alert_filters.py', '"airlines"'], ['src/alert_filters.py', '"max_points"'], ['src/alert_filters.py', '"max_taxes"'], ['src/alert_filters.py', '(no filters)']]
