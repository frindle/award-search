...
LITERALS = [[None, 'from ..airport_groups import list_groups'], [None, 'api_router = APIRouter(prefix="/api")'], [None, '@api_router.get("/airport-groups")'], [None, 'def airport_groups_list():'], [None, 'return list_groups()']]
