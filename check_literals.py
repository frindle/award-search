...
LITERALS = [[None, 'class SeatsAeroClient:'], [None, 'def search('], [None, '-> List[SeatsAeroAvailability]:'], [None, 'class SeatsAeroAvailability:'], [None, 'cabin_avail: Dict[str, bool]'], [None, 'cabin_cost: Dict[str, int]'], [None, 'cabin_seats: Dict[str, int]'], [None, 'cabin_airlines: Dict[str, List[str]]'], [None, 'cabin_direct: Dict[str, bool]'], [None, 'PROGRAM_TO_SOURCE']]
