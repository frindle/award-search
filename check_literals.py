...
LITERALS = [[None, 'from datetime import datetime'], [None, "sched['last_checked'] = datetime.now().isoformat()"], [None, "sched['last_results'] = results"], [None, "sched['last_hit_count'] = len(results)"]]
