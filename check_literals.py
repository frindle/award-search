...
LITERALS = [['src/scheduled_runner.py', 'await asyncio.sleep(20)'], ['src/scheduled_runner.py', 'load_schedules()'], ['src/scheduled_runner.py', 'is_due(s)'], ['src/scheduled_runner.py', 'asyncio.to_thread(run_schedule, s)']]
