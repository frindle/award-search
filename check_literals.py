...
LITERALS = [['src/webui/scheduled_routes.py', 'from ..airport_groups import list_groups, expand_codes'], ['src/webui/scheduled_routes.py', '/groups'], ['src/webui/scheduled_routes.py', 'expand_codes'], ['src/airport_groups.py', 'def list_groups():'], ['src/airport_groups.py', 'def expand_codes(name):']]
