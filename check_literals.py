...
LITERALS = [['src/webui/scheduled_routes.py', '@router.post("/{sched_id}/toggle")'], ['src/webui/scheduled_routes.py', 'def scheduled_toggle(sched_id: str):'], ['src/webui/scheduled_routes.py', 'not bool(schedule.get("enabled", True))']]
