...
TARGET = pathlib.Path('src/scheduled_runner.py')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [['src/scheduled_runner.py', 'from .scheduled_searches import effective_programs, is_due, load_schedules, query_legs, upsert_schedule'], ['src/scheduled_runner.py', 'effective_programs'], ['src/scheduled_runner.py', 'is_due'], ['src/scheduled_runner.py', 'load_schedules'], ['src/scheduled_runner.py', 'query_legs'], ['src/scheduled_runner.py', 'upsert_schedule']]
